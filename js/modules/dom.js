...
export const expenseReceiptUploadInput = document.querySelector("#expense-receipt-upload");
export const receiptCameraButton = document.querySelector("#receipt-camera-btn");
export const receiptUploadButton = document.querySelector("#receipt-upload-btn");
